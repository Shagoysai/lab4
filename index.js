...
function loadSources(){
  const url = 'https://newsapi.org/v2/sources?apiKey=cc078ceefb554832a79a7708207759ad';
...
function loadBy(urlPart){
  hide('#error-block');
  const url = 'https://newsapi.org/v2/' + urlPart + 'apiKey=cc078ceefb554832a79a7708207759ad';
  const request = new Request(url);
  fetch(request)
    .then(function(response) { return response.json(); })
    .then(function(data) {  
